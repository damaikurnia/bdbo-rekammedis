...
public class InputData {
    ...
    public static void main(String[] args) {
        ...
        Obat obt[] = {new Obat("O001", "amoxilin", "3 x 1", "generik"), new Obat("0002", "amoxilin", "3 x 1", "generik")};
        Resep rsp = new Resep("R001", "2-5-2013", obt);
        Pasien pas = new Pasien("P001", "Ari", "Yogya", "2-2-1992", "L", "0891232222", "FST");
        RekamMedisData rm = new RekamMedisData("R001", "2-5-2013", "pusing", "pilek", "minum air putih banyak", peg, dok, rsp, pas);
        ControlData.input(rm);
        try {

            RekamMedisData template = new RekamMedisData();
